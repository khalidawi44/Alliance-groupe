...
<!-- La VIDÉO (ag-headvid) est le héros épinglé. La galerie remonte par-dessus au scroll. -->
<div id="ag-main-content">
<?php get_template_part( 'template-parts/atelier-gallery', null, array(
	'heading' => 'Que créons-nous aujourd\'hui ?',
	'sub'     => 'Chiffre un projet, refais ton site, sécurise-le, crée du contenu — chaque brique s\'ouvre en un clic.',
) ); ?>
</div>
