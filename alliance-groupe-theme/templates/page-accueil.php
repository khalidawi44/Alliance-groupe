...
$chapters = array(
	array( 'n' => '01', 't' => 'Un artisan, pas une usine', 'p' => 'De Naples à Nantes, un seul interlocuteur — du conseil à la livraison. Vous parlez directement à la personne qui fait le travail.', 'img' => 'team/fabrizio-about.jpg' ),
	array( 'n' => '02', 't' => 'La sécurité, incluse', 'p' => 'Chaque site est livré sécurisé — rare chez les agences classiques. On commence toujours par un audit gratuit, pour partir sur des bases saines.', 'img' => 'team/reunion-naples.jpg' ),
