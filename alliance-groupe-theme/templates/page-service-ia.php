...
<main>
    ...
    <section class="ag-parallax" style="background-image:url('<?php echo esc_url( get_stylesheet_directory_uri() . "/assets/images/cities/marrakech-1.jpg" ); ?>');">
        ...
        <div class="ag-container">
            <div class="ag-sdetail">
                ...
                <div class="ag-sdetail__visual ag-sdetail__visual--grid">
                    ...
                    <div class="ag-sdetail__feat"><strong>Workflows</strong><span>Automatisés</span></div>
                    ...
                    <div class="ag-sdetail__feat"><strong>Emails</strong><span>Auto-réponse</span></div>
