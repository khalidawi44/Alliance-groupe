        ...
        <div class="ag-container">
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:22px;max-width:1180px;margin:40px auto 0;">
                ...
                $features = array(
                    ...
                    array( '', 'Combats',               'CPT dédié + 6 cartes préremplies (climat, logement, services publics, démocratie, transparence, égalité).' ),
                    ...
                    array( '', 'Groupes locaux',         'Page archive avec grille des groupes existants + formulaire "Créer un groupe local" qui envoie une demande à l\'asso.' ),
                    ...
                    array( '', 'Mentions &amp; RGPD auto', 'Mentions légales et politique de confidentialité générées automatiquement depuis l\'identité légale du Customizer.' ),
