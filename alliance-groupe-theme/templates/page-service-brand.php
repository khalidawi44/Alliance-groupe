        ...
        <div class="ag-container">
            <div class="ag-sdetail">
                ...
                <div class="ag-sdetail__visual ag-sdetail__visual--grid">
                    <div class="ag-sdetail__feat"><strong>Logo</strong><span>+ déclinaisons</span></div>
                    ...
                    <div class="ag-sdetail__feat"><strong>Print</strong><span>Cartes, flyers</span></div>
...
<?php if ( function_exists( 'ag_get_service_detail' ) ) { $GLOBALS['ag_service_detail'] = ag_get_service_detail( 'brand' ); get_template_part( 'template-parts/service-detail' ); } ?>
