...
set_query_var( 'ag_metier', array(
    ...
    'business_features' => array(
        '<strong>Cabinet de recherche juridique inclus</strong> — Judilibre en direct, méta-moteur des sources officielles, salle d\'analyse de dossiers, banque d\'arguments + IA (voir ci-dessous)',
...
/* ──────────────────────────────────────────────────────────────────────────
 * SECTION PROMO — Cabinet de recherche juridique (outil inclus avec le
...
<section class="ag-section ag-jr-promo" style="padding:80px 0;background:linear-gradient(160deg,#0b1020 0%,#10162b 60%,#0b1020 100%);color:#fff;">
    <div class="ag-container" style="max-width:1080px;margin:0 auto;padding:0 22px;">
        ...
        <h2 style="text-align:center;font-size:clamp(1.7rem,4vw,2.6rem);margin:0 0 14px;line-height:1.15;">Un cabinet de <span style="color:#D4B45C;">recherche juridique</span> intégré à votre site</h2>
