    ...
    <section class="ag-section ag-section--marbre">
        <div class="ag-container ag-container--narrow">
            ...
            <div class="ag-fondateur-story">
                ...
                <p>Aujourd'hui, Fabrizio partage son activité entre <strong>Naples</strong> — sa ville, sa base — et <strong>Nantes</strong>. Studio indépendant : un seul interlocuteur, du conseil à la livraison. Pour les projets ambitieux, il s'entoure de partenaires freelances de confiance.</p>
