...
foreach ( array( 'ag-smtp.php', 'ag-equipe.php', 'ag-closer.php', 'ag-signature.php', 'ag-juriste.php', 'ag-negociateur.php', 'ag-reponses.php', 'ag-boite.php', 'ag-commercial-admin.php' ) as $ag_com_f ) {
