...
<main id="ag-main-content" style="background:var(--color-bg);min-height:80vh;display:flex;align-items:center;justify-content:center;text-align:center;padding:80px 24px;">
    <div>
        <p style="font-size:clamp(6rem,15vw,10rem);font-weight:800;color:var(--color-gold);line-height:1;margin-bottom:16px;">404</p>
