...
**Photos attendues :** Séance en situation, matériel, portrait du coach. Lumineux, énergique.
...
```bash
bash scripts/release.sh ag-starter-coach <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 1 image(s), 29 fichier(s) PHP, version 1.3.6.
