...
/**
 * Helper: read a Customizer option (short alias for ag_starter_coach_get_option).
 */
if ( ! function_exists( 'ag_coach_opt' ) ) {
	function ag_coach_opt( $key, $default = '' ) {
 ...
 */
if ( ! function_exists( 'ag_coach_page_section_text' ) ) {
	function ag_coach_page_section_text( $slug, $fallback_h2, $fallback_lead = '' ) {
 ...
 */
if ( ! function_exists( 'ag_coach_render_split_title' ) ) {
	function ag_coach_render_split_title( $title ) {
...
add_action( 'after_setup_theme', function () {
    ...
    $GLOBALS['ag_pro'] = new AG_Pro_Features( 'ag-starter-coach' );
}, 20 );
