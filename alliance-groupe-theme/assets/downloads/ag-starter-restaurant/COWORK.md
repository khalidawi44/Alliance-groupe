...
**Photos attendues :** Assiettes dressées en lumière naturelle, salle, cuisine en action, chef. Le plat en gros plan vend plus que la façade.
...
```bash
bash scripts/release.sh ag-starter-restaurant <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 1 image(s), 34 fichier(s) PHP, version 1.24.3.
