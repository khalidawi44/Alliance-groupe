 ...
 */
if ( ! function_exists( 'ag_resto_opt' ) ) {
	function ag_resto_opt( $key, $default = '' ) {
 ...
 * correspondante (Pages > [slug]). L'utilisateur edite UNIQUEMENT la page :
 * son titre devient le H2 de la section, son premier paragraphe devient
 * l'intro de la section sur l'accueil.
 *
 ...
 */
if ( ! function_exists( 'ag_resto_page_section_text' ) ) {
	function ag_resto_page_section_text( $slug, $fallback_h2, $fallback_lead = '' ) {
 ...
 * d'origine (mot final dans <span> pour la couleur accent).
 */
if ( ! function_exists( 'ag_resto_render_split_title' ) ) {
	function ag_resto_render_split_title( $title ) {
