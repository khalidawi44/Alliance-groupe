...
$timelines = array(
	...
	'generaliste' => array(
		array( 'year' => '2015', 'text' => "Création de l'entreprise sur le principe : un restaurant polyvalent, partout." ),
	...
	<?php while ( have_posts() ) : the_post(); ?>
		<section class="ag-page-hero ag-page-hero--full"<?php if ( $ag_hero_image ) : ?> style="background-image:url('<?php echo esc_url( $ag_hero_image ); ?>');"<?php endif; ?>>
			<div class="ag-container">
				...
				<p class="ag-page-hero-sub">Un savoir-faire restaurantal, transmis et entretenu chaque jour.</p>
			</div>
		</section>
	<?php endwhile; ?>
	...
	<section class="ag-about-wrap">
		<div class="ag-about-grid">
			<div class="ag-about-text ag-anim">
				...
				<h2>Un savoir-faire restaurantal, transmis et entretenu chaque jour.</h2>
