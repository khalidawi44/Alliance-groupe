...
// Temoignages
$testimonials = array();
if ( class_exists( 'AG_Restaurant_Presets' ) ) {
	foreach ( array( 1, 2, 3 ) as $i ) {
		$t = AG_Restaurant_Presets::get_testimonial( $i );
	...
	<?php while ( have_posts() ) : the_post(); ?>
		<section class="ag-page-hero ag-page-hero--full"<?php if ( $ag_hero_image ) : ?> style="background-image:url('<?php echo esc_url( $ag_hero_image ); ?>');"<?php endif; ?>>
			<div class="ag-container">
				...
				<p class="ag-page-hero-sub">Découvrez quelques-uns de nos projets récents.</p>
			</div>
		</section>
