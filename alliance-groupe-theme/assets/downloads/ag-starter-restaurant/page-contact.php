...
$map_query     = urlencode( ag_restaurant_opt( 'ag_restaurant_address', 'Paris, France' ) );
			...
			<div class="ag-zones-list ag-anim">
				...
				<ul style="list-style:none;padding:0;">
					<li style="border-bottom:1px solid #ececec;padding:14px 0;">
						...
						<span style="color:#333;">[Votre entreprise]<br>12 rue des Restaurants<br>75001 Paris, France</span>
					</li>
					<li style="border-bottom:1px solid #ececec;padding:14px 0;">
