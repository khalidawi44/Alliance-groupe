...
- Version publiée : **1.0.2**
- Famille : **PAYANT**
- Métier : Add-on Premium Domicile
- Fichiers PHP : **3**
- **Images présentes : 0**

> ⚠️ **Zéro image.** C'est le problème n°1 : un template sans visuel ne se vend pas.

**Note :** S'active APRÈS ag-starter-domicile. Règle #13 applicable au hero.
...
```bash
bash scripts/release.sh ag-premium-domicile <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 0 image(s), 3 fichier(s) PHP, version 1.0.2.
