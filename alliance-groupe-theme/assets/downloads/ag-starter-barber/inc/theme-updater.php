<?php
/**
 * Auto-update du theme AG Starter Barber via raw GitHub.
 * Apparait dans Apparence > Themes comme un theme standard.
 */
if ( ! defined( 'ABSPATH' ) ) exit;

class AG_Barber_Theme_Updater {
	const JSON_URL  = 'https://raw.githubusercontent.com/khalidawi44/Alliance-groupe/main/alliance-groupe-theme/assets/downloads/ag-starter-barber.json';
	const SLUG      = 'ag-starter-barber';
	const CACHE_KEY = 'ag_barber_theme_remote';
	...
	public static function maybe_force_check() {
		if ( empty( $_GET['ag_barber_check_theme'] ) || ! current_user_can( 'manage_options' ) ) return;
		delete_site_transient( 'update_themes' );
		delete_transient( self::CACHE_KEY );
		wp_safe_redirect( admin_url( 'themes.php?ag_barber_theme_checked=1' ) );
		exit;
	}
