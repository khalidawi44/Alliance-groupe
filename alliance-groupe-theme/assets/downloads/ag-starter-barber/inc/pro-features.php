...
class AG_Pro_Features {
    ...
    public function enqueue_pro_assets() {
        ...
        wp_enqueue_script( 'ag-premium-scripts',
            ...
            array(), '2.0.0', true );
        wp_add_inline_style( 'ag-starter-barber-style', $this->get_pro_css() );
    }
...
.ag-header.scrolled{background:rgba(10,10,15,.97) !important;box-shadow:0 2px 20px rgba(0,0,0,.4);}
