...
- Version publiée : **1.6.2**
- Famille : **OUTIL**
- Métier : Outil de recherche avocat
- Fichiers PHP : **4**
- **Images présentes : 4**

**Note :** Outil interne, pas un template vitrine vendu.
...
**Photos attendues :** 4 images déjà présentes.
...
```bash
bash scripts/release.sh ag-avocat-recherche <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 4 image(s), 4 fichier(s) PHP, version 1.6.2.
