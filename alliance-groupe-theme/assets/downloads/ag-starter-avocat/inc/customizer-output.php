<?php
/**
 * AG Starter Avocat — Customizer output.
 *
 ...
 * @return string
 */
function ag_starter_avocat_customizer_css() {
	$accent     = ag_starter_avocat_get_option( 'ag_color_accent' );
	$background = ag_starter_avocat_get_option( 'ag_color_background' );
	$panel      = ag_starter_avocat_get_option( 'ag_color_panel' );
	$border     = ag_starter_avocat_get_option( 'ag_color_border' );
	$text       = ag_starter_avocat_get_option( 'ag_color_text' );
	$heading    = ag_starter_avocat_get_option( 'ag_color_heading' );
	$muted      = ag_starter_avocat_get_option( 'ag_color_muted' );

	$family = ag_starter_avocat_get_option( 'ag_font_family' );
	$size   = absint( ag_starter_avocat_get_option( 'ag_font_base_size' ) );
	$scale  = ag_starter_avocat_get_option( 'ag_font_heading_scale' );
 ...
 */
function ag_starter_avocat_enqueue_dynamic_css() {
	$css = ag_starter_avocat_customizer_css();
	if ( $css ) {
		wp_add_inline_style( 'ag-starter-avocat-style', $css );
	}
}
add_action( 'wp_enqueue_scripts', 'ag_starter_avocat_enqueue_dynamic_css', 20 );
