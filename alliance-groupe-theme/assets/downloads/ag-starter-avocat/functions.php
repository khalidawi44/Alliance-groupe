...
function ag_starter_avocat_companion_notice() {
	...
	<div class="ag-welcome-banner" style="background:linear-gradient(135deg,#1a1a2e 0%,#0a0a0f 100%);border:1px solid rgba(212,180,92,.3);border-left:4px solid #D4B45C;border-radius:8px;padding:40px 36px;margin:20px 20px 20px 0;display:flex;align-items:center;gap:32px;flex-wrap:wrap;">
		...
		<div style="text-align:center;">
			<a href="<?php echo esc_url( $search_url ); ?>" style="display:inline-block;background:#D4B45C;color:#0a0a0f;font-size:1.05rem;font-weight:700;padding:16px 32px;border-radius:8px;text-decoration:none;box-shadow:0 4px 16px rgba(212,180,92,.3);"><?php esc_html_e( 'Installer AG Starter Companion →', 'ag-starter-avocat' ); ?></a>
			<p style="color:rgba(255,255,255,.4);font-size:.8rem;margin-top:10px;"><?php esc_html_e( 'Plugin gratuit — installation en 10 secondes', 'ag-starter-avocat' ); ?></p>
		</div>
	</div>
	<?php
}
...
function ag_starter_avocat_dashboard_widget_render() {
	...
	<div style="text-align:center;padding:20px 0;">
		...
		<a href="<?php echo esc_url( $search_url ); ?>" class="button button-primary button-hero"><?php esc_html_e( 'Installer AG Starter Companion →', 'ag-starter-avocat' ); ?></a>
