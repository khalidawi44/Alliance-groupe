...
function ag_starter_avocat_companion_notice() {
	...
	echo '<div class="notice notice-info is-dismissible"><p><strong>AG Starter Avocat</strong> &mdash; ';
	printf(
		/* translators: %s: plugin search link. */
		wp_kses( __( 'Installez le plugin gratuit %s pour importer en un clic les pages, le menu et les reglages de ce theme.', 'ag-starter-avocat' ), array( 'a' => array( 'href' => array() ), 'strong' => array() ) ),
