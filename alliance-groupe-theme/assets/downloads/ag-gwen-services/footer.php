...
.ag-site-footer .ag-footer-cta{display:inline-block;margin-top:12px;background:linear-gradient(120deg,#1a5e3a,#2f8552);color:#fff;font-weight:800;font-size:.98rem;text-decoration:none;padding:13px 26px;border-radius:100px;box-shadow:0 14px 30px -14px rgba(47,125,84,.8);transition:transform .2s ease,filter .2s ease;}
