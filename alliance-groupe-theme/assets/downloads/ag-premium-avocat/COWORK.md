...
```bash
bash scripts/release.sh ag-premium-avocat <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 0 image(s), 3 fichier(s) PHP, version 0.6.0.
