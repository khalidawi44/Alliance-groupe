...
**Photos attendues :** À cadrer avec Fabrice — 1 seul fichier PHP, template le plus léger du lot.
...
```bash
bash scripts/release.sh ag-starter-companion <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 1 image(s), 1 fichier(s) PHP, version 1.13.2.
