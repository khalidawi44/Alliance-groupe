<?php
/**
 * Auto-update du theme AG Starter Association via raw GitHub.
 * Apparait dans Apparence > Themes comme un theme standard.
 */
if ( ! defined( 'ABSPATH' ) ) exit;

class AG_Asso_Theme_Updater {
	...
	public static function maybe_force_check() {
		if ( empty( $_GET['ag_asso_check_theme'] ) || ! current_user_can( 'manage_options' ) ) return;
		delete_site_transient( 'update_themes' );
		delete_transient( self::CACHE_KEY );
		wp_safe_redirect( admin_url( 'themes.php?page=ag-asso-welcome&ag_asso_theme_checked=1' ) );
		exit;
	}
