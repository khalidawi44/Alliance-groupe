...
**Note :** Autorisation à l'image obligatoire pour toute personne reconnaissable.
...
**Photos attendues :** Bénévoles en action, collectif, terrain. Humain avant tout, jamais de stock photo générique.
...
```bash
bash scripts/release.sh ag-starter-association <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 0 image(s), 16 fichier(s) PHP, version 0.56.2.
