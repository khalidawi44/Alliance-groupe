...
class ag_domicile_Devis {
	...
	public static function register_cpt() {
		register_post_type( 'ag_devis_lead', array(
			'label'         => __( 'Demandes de devis', 'ag-starter-domicile' ),
			'public'        => false,
			'show_ui'       => true,
			'show_in_menu'  => true,
			...
			'labels'        => array(
				'name'          => __( 'Demandes de devis', 'ag-starter-domicile' ),
				'singular_name' => __( 'Demande de devis', 'ag-starter-domicile' ),
				'menu_name'     => '💼 ' . __( 'Devis demandés', 'ag-starter-domicile' ),
			),
		) );
	}
