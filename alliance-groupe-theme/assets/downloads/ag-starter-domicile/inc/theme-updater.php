<?php
/**
 * Auto-update du theme AG Starter Domicile via raw GitHub.
 */
if ( ! defined( 'ABSPATH' ) ) exit;

class AG_Domicile_Theme_Updater {
	const JSON_URL  = 'https://raw.githubusercontent.com/khalidawi44/Alliance-groupe/main/alliance-groupe-theme/assets/downloads/ag-starter-domicile.json';
	const SLUG      = 'ag-starter-domicile';
	...
	public static function maybe_force_check() {
		if ( empty( $_GET['ag_domicile_check_theme'] ) || ! current_user_can( 'manage_options' ) ) return;
