<?php
/**
 * AG Starter Domicile Customizer.
 *
...
function ag_starter_domicile_customize_register( $wp_customize ) {
	...
	$wp_customize->add_panel(
		'ag_starter_panel',
		array(
			'title'       => esc_html__( 'AG Starter — Personnalisation', 'ag-starter-domicile' ),
			'description' => esc_html__( 'Modifiez les couleurs, la typographie et les textes cles de votre theme directement ici. Aucun code requis.', 'ag-starter-domicile' ),
			'priority'    => 30,
		)
	);
	...
	$wp_customize->add_section(
		'ag_section_upgrade',
		array(
			'title'    => esc_html__( '💎 Ameliorer mon theme', 'ag-starter-domicile' ),
	...
	$wp_customize->add_section(
		'ag_section_colors',
		array(
			'title'    => esc_html__( 'Couleurs du theme', 'ag-starter-domicile' ),
			'panel'    => 'ag_starter_panel',
			'priority' => 10,
		)
	);
	...
	$colors = array(
		'ag_color_accent'     => esc_html__( 'Couleur d\'accent', 'ag-starter-domicile' ),
		'ag_color_background' => esc_html__( 'Arriere-plan principal', 'ag-starter-domicile' ),
		'ag_color_panel'      => esc_html__( 'Arriere-plan des cartes', 'ag-starter-domicile' ),
		'ag_color_border'     => esc_html__( 'Couleur des bordures', 'ag-starter-domicile' ),
		'ag_color_text'       => esc_html__( 'Couleur du texte', 'ag-starter-domicile' ),
		'ag_color_heading'    => esc_html__( 'Couleur des titres', 'ag-starter-domicile' ),
		'ag_color_muted'      => esc_html__( 'Texte secondaire', 'ag-starter-domicile' ),
	);
	$priority = 10;
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'Typographie', 'ag-starter-domicile' ),
			'panel'    => 'ag_starter_panel',
			'priority' => 20,
		)
	);
	...
	$wp_customize->add_control(
		'ag_font_family',
		array(
			'label'   => esc_html__( 'Famille de police', 'ag-starter-domicile' ),
			'section' => 'ag_section_typography',
			'type'    => 'select',
			'choices' => array(
				'system'     => esc_html__( 'Systeme (defaut, rapide)', 'ag-starter-domicile' ),
				'sans'       => esc_html__( 'Sans-serif classique', 'ag-starter-domicile' ),
				'serif'      => esc_html__( 'Serif (elegant)', 'ag-starter-domicile' ),
				'monospace'  => esc_html__( 'Monospace', 'ag-starter-domicile' ),
			),
		)
	);
	...
	$wp_customize->add_control(
		'ag_font_base_size',
		array(
			'label'       => esc_html__( 'Taille de base du texte (px)', 'ag-starter-domicile' ),
			'description' => esc_html__( 'Entre 14 et 20.', 'ag-starter-domicile' ),
			'section'     => 'ag_section_typography',
			'type'        => 'number',
			'input_attrs' => array(
				'min'  => 14,
	...
	$wp_customize->add_control(
		'ag_font_heading_scale',
		array(
			'label'   => esc_html__( 'Taille des titres', 'ag-starter-domicile' ),
			'section' => 'ag_section_typography',
			'type'    => 'select',
			'choices' => array(
				'small'   => esc_html__( 'Compact', 'ag-starter-domicile' ),
				'default' => esc_html__( 'Par defaut', 'ag-starter-domicile' ),
				'large'   => esc_html__( 'Grand', 'ag-starter-domicile' ),
			),
		)
	);
	...
	$wp_customize->add_section(
		'ag_section_hero',
		array(
			'title'    => esc_html__( 'Hero (accueil)', 'ag-starter-domicile' ),
			'panel'    => 'ag_starter_panel',
			'priority' => 30,
		)
	);
	...
	$hero_fields = array(
		'ag_hero_show'       => array(
			'label' => esc_html__( 'Afficher le hero', 'ag-starter-domicile' ),
			'type'  => 'checkbox',
		),
		'ag_hero_prefix'     => array(
			'label' => esc_html__( 'Prefixe du titre', 'ag-starter-domicile' ),
			'type'  => 'text',
		),
		'ag_hero_brand'      => array(
			'label' => esc_html__( 'Nom de l\'etablissement', 'ag-starter-domicile' ),
			'type'  => 'text',
		),
		'ag_hero_subtitle'   => array(
			'label' => esc_html__( 'Sous-titre', 'ag-starter-domicile' ),
			'type'  => 'textarea',
		),
		'ag_hero_button'     => array(
			'label' => esc_html__( 'Texte du bouton', 'ag-starter-domicile' ),
			'type'  => 'text',
		),
		'ag_hero_button_url' => array(
			'label' => esc_html__( 'Lien du bouton (URL ou #ancre)', 'ag-starter-domicile' ),
			'type'  => 'text',
		),
	);
	$prio = 10;
	...
	$wp_customize->add_section(
		'ag_section_footer',
		array(
			'title'    => esc_html__( 'Pied de page', 'ag-starter-domicile' ),
			'panel'    => 'ag_starter_panel',
			'priority' => 40,
		)
	);
	...
	$wp_customize->add_control(
		'ag_footer_copyright',
		array(
			'label'       => esc_html__( 'Texte de copyright personnalise', 'ag-starter-domicile' ),
			'description' => esc_html__( 'Laissez vide pour le texte par defaut.', 'ag-starter-domicile' ),
	...
	$wp_customize->add_control(
		'ag_footer_credits',
		array(
			'label'   => esc_html__( 'Afficher le credit "Theme gratuit par Alliance Group"', 'ag-starter-domicile' ),
			'section' => 'ag_section_footer',
			'type'    => 'checkbox',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'       => esc_html__( 'Contenu accueil — textes', 'ag-starter-domicile' ),
			'panel'       => 'ag_starter_panel',
			'priority'    => 55,
			'description' => esc_html__( 'Personnalisez les phrases d\'introduction (sous les titres) de chaque section de l\'accueil.', 'ag-starter-domicile' ),
		)
	);
	$ag_domicile_home_fields = array(
		'ag_domicile_individuel_title_pre'  => array( 'label' => esc_html__( 'Accompagnement individuel — debut du titre', 'ag-starter-domicile' ),  'type' => 'text' ),
		'ag_domicile_individuel_title_em'   => array( 'label' => esc_html__( 'Accompagnement individuel — mot accentue', 'ag-starter-domicile' ),    'type' => 'text' ),
		'ag_domicile_individuel_lead'       => array( 'label' => esc_html__( 'Accompagnement individuel — phrase d\'intro', 'ag-starter-domicile' ), 'type' => 'textarea' ),
		'ag_domicile_groupe_title_pre'      => array( 'label' => esc_html__( 'Seances de groupe — debut du titre', 'ag-starter-domicile' ),    'type' => 'text' ),
		'ag_domicile_groupe_title_em'       => array( 'label' => esc_html__( 'Seances de groupe — mot accentue', 'ag-starter-domicile' ),      'type' => 'text' ),
		'ag_domicile_groupe_lead'           => array( 'label' => esc_html__( 'Seances de groupe — phrase d\'intro', 'ag-starter-domicile' ),   'type' => 'textarea' ),
		'ag_domicile_temoignages_title_pre' => array( 'label' => esc_html__( 'Temoignages — debut du titre', 'ag-starter-domicile' ),          'type' => 'text' ),
		'ag_domicile_temoignages_title_em'  => array( 'label' => esc_html__( 'Temoignages — mot accentue', 'ag-starter-domicile' ),            'type' => 'text' ),
		'ag_domicile_temoignages_lead'      => array( 'label' => esc_html__( 'Temoignages — phrase d\'intro', 'ag-starter-domicile' ),         'type' => 'textarea' ),
		'ag_domicile_about_title_pre'       => array( 'label' => esc_html__( 'Mon parcours — debut du titre', 'ag-starter-domicile' ),         'type' => 'text' ),
		'ag_domicile_about_title_em'        => array( 'label' => esc_html__( 'Nos engagements — mot accentue', 'ag-starter-domicile' ),           'type' => 'text' ),
		'ag_domicile_about_p1'              => array( 'label' => esc_html__( 'Mon parcours — paragraphe 1', 'ag-starter-domicile' ),           'type' => 'textarea' ),
		'ag_domicile_about_p2'              => array( 'label' => esc_html__( 'Mon parcours — paragraphe 2', 'ag-starter-domicile' ),           'type' => 'textarea' ),
	);
	$ag_prio = 10;
...
function ag_starter_domicile_register_upgrade_control() {
	...
	class AG_Starter_Domicile_Upgrade_Control extends WP_Customize_Control {
		...
		public function render_content() {
			$utm     = '?utm_source=wp-customizer&utm_medium=ag-starter-domicile&utm_campaign=upgrade';
			...
			<div style="background:#fff;border:1px solid #d4b45c;border-radius:8px;padding:14px;margin-top:8px;">
				...
				<?php if ( ! empty( $packs ) ) : ?>
					<?php if ( 'free' === $tier ) : ?>
						<p style="margin:0 0 12px;color:#50575e;font-size:12px;line-height:1.5;">
							<?php esc_html_e( 'Vous utilisez la version gratuite. Packs payants disponibles :', 'ag-starter-domicile' ); ?>
						</p>
					<?php else : ?>
						<p style="margin:0 0 12px;color:#50575e;font-size:12px;line-height:1.5;">
							<?php esc_html_e( 'Upgrader vers le niveau supérieur :', 'ag-starter-domicile' ); ?>
						</p>
					<?php endif; ?>
				...
				<div style="margin-top:14px;padding-top:12px;border-top:1px dashed #d4b45c;text-align:center;">
					<a href="<?php echo esc_url( $contact ); ?>" target="_blank" rel="noopener" style="display:inline-block;color:#14140f;background:#d4b45c;padding:8px 14px;border-radius:4px;font-size:12px;font-weight:700;text-decoration:none;">
						💎 <?php esc_html_e( 'Site sur-mesure (+340% leads) →', 'ag-starter-domicile' ); ?>
					</a>
					<p style="margin:8px 0 0;color:#888;font-size:11px;">
						<?php esc_html_e( 'Premier appel gratuit, sans engagement', 'ag-starter-domicile' ); ?>
					</p>
				</div>
			</div>
			<?php
