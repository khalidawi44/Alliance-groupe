...
- Version publiée : **1.0.4**
- Famille : **GRATUIT**
- Métier : Services à domicile
- Fichiers PHP : **29**
- **Images présentes : 2**

**Note :** ⚠️ RÈGLE PERMANENTE #13 — NE JAMAIS toucher/remplacer l'image du HERO (assets/hero.jpg, theme_mod ag_domicile_hero_custom, ag_domicile_hero_image). Fabrice la gère lui-même via Apparence > Personnaliser. Interdiction de déployer une image de hero.
...
**Photos attendues :** Aide à domicile, accompagnement senior, garde d'enfants. Douceur, lumière naturelle.
...
```bash
bash scripts/release.sh ag-starter-domicile <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 2 image(s), 29 fichier(s) PHP, version 1.0.4.
