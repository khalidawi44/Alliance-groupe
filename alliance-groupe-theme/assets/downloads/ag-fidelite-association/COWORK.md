# COWORK — ag-fidelite-association
...
- Version publiée : **0.50.1**
- Famille : **PAYANT**
- Métier : Add-on Fidélité Association
- Fichiers PHP : **10**
- **Images présentes : 0**

> ⚠️ **Zéro image.** C'est le problème n°1 : un template sans visuel ne se vend pas.

**Note :** S'active APRÈS ag-starter-association.
...
```bash
bash scripts/release.sh ag-fidelite-association <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 0 image(s), 10 fichier(s) PHP, version 0.50.1.
