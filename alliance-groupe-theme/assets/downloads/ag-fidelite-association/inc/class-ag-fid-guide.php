	...
	private static function get_sections() {
		return array(
			...
			array(
				...
				'desc'  => 'La page d\'accueil affiche des sections stylees (hero, manifeste, combats, evenements, dons...). Tous les TEXTES sont editables via Customizer. Le CONTENU dynamique (cards combats, events, articles) vient des CPT admin.',
				'rows'  => array(
					...
					array( 'Titres des bandeaux parallax (4 sections)',            'Apparence > Personnaliser > Contenu accueil' ),
					array( 'Images de fond des bandeaux parallax (4 sections)',    'Apparence > Personnaliser > Contenu accueil' ),
					array( 'Titres + intros + bouton de chaque section',           'Apparence > Personnaliser > Contenu accueil' ),
