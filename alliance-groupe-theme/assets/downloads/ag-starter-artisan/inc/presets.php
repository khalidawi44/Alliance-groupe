...
class AG_Artisan_Presets {
	...
	public static function get_presets() {
		return array(
			...
			'traiteur' => array(
				...
				'desc'  => 'Cocktails, buffets, repas assis, mariages, séminaires. Cuisine maison, produits frais et locaux.',
				'mods'  => array(
					'ag_color_accent'        => '#C8923C',
					'ag_hero_prefix'         => 'Traiteur',
					'ag_hero_brand'          => 'événementiel',
					'ag_hero_subtitle'       => 'Cocktails, buffets, repas assis, mariages, événements pro — cuisine maison, produits frais et locaux, du dressage au service à table.',
					'ag_hero_button'         => 'Demander un devis',
					'ag_hero_button_url'     => '/devis/',
					'ag_artisan_metier_nom'  => 'Traiteur',
					'ag_artisan_hero_image'  => 'https://images.unsplash.com/photo-1555244162-803834f70033?w=1600&q=80',
					'ag_artisan_testi_1'     => 'Mariage de 120 invités : buffet impeccable, service souriant, mention spéciale au foie gras maison.|Émilie F.|Lyon',
					'ag_artisan_testi_2'     => 'Séminaire d\'entreprise sur 3 jours : déjeuners + cocktail de gala. Logistique parfaite.|Thomas D.|Paris',
					'ag_artisan_testi_3'     => 'Cocktail dînatoire 80 personnes à domicile, fraîcheur exceptionnelle, vaisselle reprise. Au top.|Nora M.|Nice',
				),
				'services' => array(
					array( 'emoji' => '🥂', 'title' => 'Cocktails apéritifs' ),
					array( 'emoji' => '🍱', 'title' => 'Buffets froids/chauds' ),
					array( 'emoji' => '🍽️', 'title' => 'Repas assis service' ),
					array( 'emoji' => '💒', 'title' => 'Mariages clé en main' ),
					array( 'emoji' => '🏢', 'title' => 'Séminaires entreprise' ),
					array( 'emoji' => '🎂', 'title' => 'Pièces montées' ),
					array( 'emoji' => '🥪', 'title' => 'Plateaux repas pro' ),
					array( 'emoji' => '🌿', 'title' => 'Menu végé/vegan' ),
				),
				'how' => array(
					array( 'emoji' => '📋', 'title' => 'Brief gratuit', 'desc' => 'Vous nous décrivez votre événement : nombre d\'invités, budget, ambiance, contraintes alimentaires.' ),
					array( 'emoji' => '👨‍🍳', 'title' => 'Menu sur mesure', 'desc' => 'Proposition de menus personnalisés sous 72h. Dégustation possible sur RDV.' ),
					array( 'emoji' => '🚐', 'title' => 'Livraison + service', 'desc' => 'Dressage, service à table, débarrassage, reprise de la vaisselle. Vous profitez de votre événement.' ),
				),
				'faq' => array(
					array( 'q' => 'À partir de combien de personnes intervenez-vous ?', 'a' => 'À partir de 15 personnes pour les buffets, 30 pour les repas assis avec service. En dessous : plateaux repas livrés.' ),
					array( 'q' => 'Faites-vous le menu végétarien / vegan / sans gluten ?', 'a' => 'Oui — cartes dédiées, ainsi que casher et halal certifiés sur commande spéciale.' ),
				...
				'pages' => array(
					...
					'prestations'        => "Cocktails apéritifs (canapés, verrines, pièces salées chaudes), buffets froids ou chauds (avec ou sans service), repas assis à 2 ou 3 services, brunchs, cocktails dînatoires.\n\nMariages clé en main : du vin d'honneur à la pièce montée finale, avec service en salle. Séminaires d'entreprise : petits-déjeuners, pauses gourmandes, déjeuners de travail, cocktails de gala. Plateaux repas pour réunions de travail.\n\nMenus sur mesure : nous adaptons selon vos goûts, votre budget (à partir de 18 €/personne pour un cocktail, 45 €/personne pour un repas assis 3 services), vos contraintes alimentaires. Dégustation préalable sur RDV pour les gros événements.",
					'zones-intervention' => "Zone d'intervention : agglomération + tout le département pour les buffets et repas assis. Pour les mariages et grands événements, nous nous déplaçons dans toute la région et les départements limitrophes (frais de transport au km transparents).\n\nNous disposons d'un camion frigorifique et de matériel de service complet (vaisselle, verres, nappes, brûleurs, fontaines à champagne) — vous n'avez rien à louer en plus.\n\nUrgences (commande dernière minute, < 7 jours) : possible selon disponibilité avec menu pré-établi. Réservations conseillées 4-6 semaines à l'avance pour menus sur mesure.",
					'realisations'       => "Plus de 1 200 événements réalisés en 18 ans : 320 mariages, 180 séminaires d'entreprise, 50+ inaugurations et lancements presse, des centaines de cocktails et anniversaires.\n\nClients récurrents : grandes entreprises locales en contrat séminaires/cocktails, mairie pour cérémonies officielles, châteaux et domaines partenaires pour mariages. Référencé sur Mariages.net, Zankyou et Salon du Mariage régional.\n\nDécouvrez notre portfolio en images plus bas — nos plus belles tables et nos pièces signature. Demandez un devis personnalisé pour votre événement, réponse sous 72h avec menus, photos et tarifs détaillés.",
				),
			),
	...
	/**
	 * Réglages Personnaliser pour rendre éditables (modifiables après
	 * application d'un preset) les chiffres clés, les témoignages et la
	 * FAQ. Override manuel : prime sur le contenu du preset.
	 */
	public static function customize_content( $wp ) {
		// ── Chiffres clés (hero) ──
		$wp->add_section( 'ag_artisan_stats', array(
			'title'       => '📊 ' . __( 'Chiffres clés (accueil)', 'ag-starter-artisan' ),
			'priority'    => 27,
			'description' => __( 'Une statistique par ligne : valeur | libellé (ex : 600+ | Chantiers terminés). Laissez vide pour garder les chiffres du preset choisi.', 'ag-starter-artisan' ),
		) );
		$wp->add_setting( 'ag_artisan_stats_edit', array(
			'default'           => '',
			'sanitize_callback' => array( __CLASS__, 'sanitize_edit' ),
		) );
		$wp->add_control( 'ag_artisan_stats_edit', array(
			'label'       => __( 'Vos chiffres clés (3 recommandés)', 'ag-starter-artisan' ),
			'section'     => 'ag_artisan_stats',
			'type'        => 'textarea',
			'input_attrs' => array( 'rows' => 4 ),
		) );

		// ── Témoignages ──
		$wp->add_section( 'ag_artisan_testi', array(
			'title'       => '💬 ' . __( 'Témoignages (accueil)', 'ag-starter-artisan' ),
			'priority'    => 28,
			'description' => __( 'Trois avis clients. Format : texte | nom | ville. Videz un champ pour retirer le témoignage. N\'inventez pas de faux avis.', 'ag-starter-artisan' ),
		) );
		for ( $i = 1; $i <= 3; $i++ ) {
			$wp->add_setting( 'ag_artisan_testi_' . $i, array(
				'default'           => '',
				'sanitize_callback' => array( __CLASS__, 'sanitize_edit' ),
			) );
			$wp->add_control( 'ag_artisan_testi_' . $i, array(
				'label'       => sprintf( __( 'Témoignage %d (texte | nom | ville)', 'ag-starter-artisan' ), $i ),
				'section'     => 'ag_artisan_testi',
				'type'        => 'textarea',
		...
		// ── FAQ ──
		$wp->add_section( 'ag_artisan_faq', array(
			'title'       => '❓ ' . __( 'FAQ (accueil)', 'ag-starter-artisan' ),
			'priority'    => 29,
			'description' => __( 'Une question par ligne : Question | Réponse. Laissez vide pour garder la FAQ du preset choisi.', 'ag-starter-artisan' ),
		) );
		$wp->add_setting( 'ag_artisan_faq_edit', array(
			'default'           => '',
			'sanitize_callback' => array( __CLASS__, 'sanitize_edit' ),
		) );
		$wp->add_control( 'ag_artisan_faq_edit', array(
			'label'       => __( 'Votre FAQ', 'ag-starter-artisan' ),
			'section'     => 'ag_artisan_faq',
			'type'        => 'textarea',
			'input_attrs' => array( 'rows' => 6 ),
		) );

		// ── Galerie « Réalisations » (page Réalisations) ──
		$wp->add_section( 'ag_artisan_gallery', array(
			'title'       => '🖼️ ' . __( 'Galerie réalisations', 'ag-starter-artisan' ),
			'priority'    => 30,
			'description' => __( 'Vos vraies photos de chantier (6 max). Dès qu\'une image est ajoutée ici, elle remplace les photos d\'illustration du métier. Ajoutez une légende sous chaque photo.', 'ag-starter-artisan' ),
		) );
		for ( $i = 1; $i <= 6; $i++ ) {
			$wp->add_setting( 'ag_artisan_gallery_img_' . $i, array(
				'default'           => '',
				'sanitize_callback' => 'esc_url_raw',
			) );
			$wp->add_control( new WP_Customize_Image_Control( $wp, 'ag_artisan_gallery_img_' . $i, array(
				'label'   => sprintf( __( 'Réalisation %d — photo', 'ag-starter-artisan' ), $i ),
				'section' => 'ag_artisan_gallery',
			) ) );
			$wp->add_setting( 'ag_artisan_gallery_cap_' . $i, array(
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			) );
			$wp->add_control( 'ag_artisan_gallery_cap_' . $i, array(
				'label'   => sprintf( __( 'Réalisation %d — légende', 'ag-starter-artisan' ), $i ),
				'section' => 'ag_artisan_gallery',
				'type'    => 'text',
			) );
		}

		// ── Qui sommes-nous : photo équipe + timeline ──
		$wp->add_section( 'ag_artisan_about', array(
			'title'       => '🏛️ ' . __( 'Qui sommes-nous', 'ag-starter-artisan' ),
			'priority'    => 31,
			'description' => __( 'Votre photo d\'équipe/atelier et votre histoire. Pour la timeline : une étape par ligne au format « Année | Texte ». Laissez vide pour garder le contenu du preset.', 'ag-starter-artisan' ),
		) );
		$wp->add_setting( 'ag_artisan_about_photo', array(
			'default'           => '',
			'sanitize_callback' => 'esc_url_raw',
		) );
		$wp->add_control( new WP_Customize_Image_Control( $wp, 'ag_artisan_about_photo', array(
			'label'   => __( 'Photo équipe / atelier', 'ag-starter-artisan' ),
			'section' => 'ag_artisan_about',
		) ) );
		$wp->add_setting( 'ag_artisan_timeline_edit', array(
			'default'           => '',
			'sanitize_callback' => array( __CLASS__, 'sanitize_edit' ),
		) );
		$wp->add_control( 'ag_artisan_timeline_edit', array(
			'label'       => __( 'Notre histoire (Année | Texte)', 'ag-starter-artisan' ),
			'section'     => 'ag_artisan_about',
			'type'        => 'textarea',
			'input_attrs' => array( 'rows' => 6 ),
		) );
	...
	public static function get_active_stats() {
		$edit = (string) get_theme_mod( 'ag_artisan_stats_edit', '' );
		if ( '' !== trim( $edit ) ) {
			$out = array();
			foreach ( preg_split( '/\r\n|\r|\n/', $edit ) as $line ) {
				$line = trim( $line );
	...
	public static function get_active_faq() {
		$edit = (string) get_theme_mod( 'ag_artisan_faq_edit', '' );
		if ( '' !== trim( $edit ) ) {
			$out = array();
			foreach ( preg_split( '/\r\n|\r|\n/', $edit ) as $line ) {
				$line = trim( $line );
