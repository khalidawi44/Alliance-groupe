...
- Version publiée : **1.15.6**
- Famille : **GRATUIT**
- Métier : Artisan (bâtiment)
- Fichiers PHP : **29**
- **Images présentes : 1**
...
**Photos attendues :** Chantier en cours, outils, réalisations finies, avant/après. L'avant/après est l'argument de vente n°1.
...
```bash
bash scripts/release.sh ag-starter-artisan <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 1 image(s), 29 fichier(s) PHP, version 1.15.6.
