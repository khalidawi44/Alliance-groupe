...
<footer class="ag-site-footer" role="contentinfo">
	<div class="ag-container">
		...
		<div class="ag-footer-bottom">
			<?php
			$ag_custom_copy = ag_starter_artisan_get_option( 'ag_footer_copyright' );
			if ( $ag_custom_copy ) :
				?>
			...
			<?php endif; ?>
			<?php if ( ag_starter_artisan_get_option( 'ag_footer_credits' ) ) : ?>
				<p>
					<?php
					/* translators: %s: Alliance Group website link. */
					printf( wp_kses( __( 'Theme gratuit par %s', 'ag-starter-artisan' ), array( 'a' => array( 'href' => array(), 'rel' => array() ) ) ), '<a href="https://alliancegroupe-inc.com/templates-wordpress" rel="nofollow">Alliance Group</a>' );
					?>
				</p>
			<?php endif; ?>
		</div>
