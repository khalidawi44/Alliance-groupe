...
- Version publiée : **0.55.0**
- Famille : **PAYANT**
- Métier : Add-on Business Avocat
- Fichiers PHP : **4**
- **Images présentes : 0**

> ⚠️ **Zéro image.** C'est le problème n°1 : un template sans visuel ne se vend pas.

**Note :** S'active APRÈS Starter + Premium.
...
```bash
bash scripts/release.sh ag-business-avocat <nouvelle-version>   # bump + json + zip + push + merge main
...
- 2026-08-27 · CODE · Création de ce fichier de liaison. Inventaire mesuré : 0 image(s), 4 fichier(s) PHP, version 0.55.0.
