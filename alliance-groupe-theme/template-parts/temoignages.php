 ...
 *
 * Uniquement des avis Google réels. Pour qu'un avis apparaisse ici, il doit
 * exister sur la fiche Google — on n'en écrit jamais à la main.
 *
 * @package Alliance_Groupe_Theme
 */
if ( ! defined( 'ABSPATH' ) ) exit;

/* VRAIS avis Google uniquement (via inc/ag-geo.php). Aucun repli : si l'API ne
   renvoie rien, la section ne s'affiche pas. On n'invente jamais d'avis. */
...
/* PAS DE REPLI. Meme decision que sur l'accueil (Fabrice, 03/09/2026) : tant
   qu'il n'y a pas de vrais avis Google, on n'affiche RIEN. Le repli qui vivait
   ici ecrivait deux temoignages en dur — dont un attribue a une structure qui
   n'est pas cliente — avec cinq etoiles codees, sous le logo Google et la
   mention « avis Google verifies ». C'etait de la preuve fabriquee, et le
   propre en-tete du fichier promettait le contraire.
...
<section class="ag-avis" aria-label="Avis clients">
	<div class="ag-avis__inner">
		<div class="ag-avis__head">
			...
			<h2 class="ag-avis__title">Des projets concrets, <em>et des avis vérifiables.</em></h2>
