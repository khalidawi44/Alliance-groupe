...
$ag_fsm_items = array(
	...
	array( 'url' => home_url( '/realisations' ),        'label' => 'Réalisations',  'sub' => '04' ),
	array( 'url' => home_url( '/a-propos' ),            'label' => 'À propos',      'sub' => '05' ),
	array( 'url' => home_url( '/contact' ),             'label' => 'Contact',       'sub' => '06' ),
);
?>
