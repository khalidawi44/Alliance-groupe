...
<section class="ag-tpl-cta-block">
	<div class="ag-tpl-cta-inner">
		...
		<div class="ag-tpl-cta-arrow" aria-hidden="true">
			<span>Découvrez chaque métier en détail ci-dessous</span>
			<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12l7 7 7-7"/></svg>
		</div>
	</div>
</section>
