			...
			<div class="ag-maitre__inner">
				...
				<div class="ag-maitre__body">
					...
					<?php $spec = ag_starter_avocat_get_option( 'ag_maitre_specialties' ); if ( $spec ) : ?>
						<p class="ag-maitre__specialties"><strong><?php echo esc_html( ag_avocat_opt( 'ag_avocat_maitre_specialties_label', __( 'Practice areas:', 'ag-starter-avocat' ) ) ); ?></strong> <?php echo esc_html( $spec ); ?></p>
					<?php endif; ?>
